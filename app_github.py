...
feature_extractor_path = 'https://github.com/vern02/app/blob/main/mobilenetv2.h5'  # Replace with your actual path
svm_model_path = 'https://github.com/vern02/app/blob/main/best_model.joblib'  # Replace with your actual path
